...
Возвращает имя пользователя с логином, указанным в URL вместо `{login}`, в формате простого текста.

Если логин не указан, или пользователя с таким логином не существует, возвращается код 400.
